...
class QuestionBankTrueOrFalseQuestionRequest extends FormRequest
{
    ...
    protected function onStore() {
        return [
            ...
            'difficulty' => ['required', new Enum(QuestionBankTrueOrFalseQuestionDifficulty::class)],
    ...
    protected function onUpdate() {
        return [
            ...
            'difficulty' => ['sometimes', new Enum(QuestionBankTrueOrFalseQuestionDifficulty::class)],
    ...
    // {
    //     return [
    //         'question_bank_id' => FieldName::question_banks->getMessage(),
