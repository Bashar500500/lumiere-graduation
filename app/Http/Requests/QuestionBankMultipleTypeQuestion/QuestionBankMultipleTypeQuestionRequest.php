...
namespace App\Http\Requests\QuestionBankMultipleTypeQuestion;
...
class QuestionBankMultipleTypeQuestionRequest extends FormRequest
{
    ...
    protected function onStore() {
        return [
            'question_bank_id' => ['required', 'exists:question_banks,id'],
            'type' => ['required', new Enum(QuestionBankMultipleTypeQuestionType::class)],
            'text' => ['required', 'string'],
            'points' => ['required', 'integer', 'gt:0'],
            'difficulty' => ['required', new Enum(QuestionBankMultipleTypeQuestionDifficulty::class)],
            'category' => ['required', 'string'],
            'required' => ['required', 'boolean'],
            'options' => ['required', 'array'],
            'options.*.text' => ['required', 'string'],
            'options.*.correct' => ['required', 'boolean'],
            'options.*.feedback' => ['sometimes', 'string'],
            'additional_settings' => ['required', 'array'],
            'additional_settings.randomize_order' => ['required', 'boolean'],
            'additional_settings.show_in_columns' => ['required', 'boolean'],
    ...
    protected function onUpdate() {
        return [
            'type' => ['sometimes', new Enum(QuestionBankMultipleTypeQuestionType::class)],
            'text' => ['sometimes', 'string'],
            'points' => ['sometimes', 'integer', 'gt:0'],
            'difficulty' => ['sometimes', new Enum(QuestionBankMultipleTypeQuestionDifficulty::class)],
            ...
            'additional_settings.randomize_order' => ['required_with:additional_settings', 'boolean'],
            'additional_settings.show_in_columns' => ['required_with:additional_settings', 'boolean'],
    ...
    // {
    //     return [
    //         'question_bank_id.required' => ValidationType::Required->getMessage(),
    //         'question_bank_id.exists' => ValidationType::Exists->getMessage(),
    ...
    //         'options.required' => ValidationType::Required->getMessage(),
    //         'options.array' => ValidationType::Array->getMessage(),
    //         'options.*.text.required' => ValidationType::Required->getMessage(),
    //         'options.*.text.required_with' => ValidationType::RequiredWith->getMessage(),
    //         'options.*.text.string' => ValidationType::String->getMessage(),
    //         'options.*.correct.required' => ValidationType::Required->getMessage(),
    //         'options.*.correct.required_with' => ValidationType::RequiredWith->getMessage(),
    //         'options.*.correct.boolean' => ValidationType::Boolean->getMessage(),
    //         'options.*.feedback.string' => ValidationType::String->getMessage(),
    //         'additional_settings.required' => ValidationType::Required->getMessage(),
    //         'additional_settings.array' => ValidationType::Array->getMessage(),
    //         'additional_settings.randomize_order.required' => ValidationType::Required->getMessage(),
    //         'additional_settings.randomize_order.required_with' => ValidationType::RequiredWith->getMessage(),
    //         'additional_settings.randomize_order.boolean' => ValidationType::Boolean->getMessage(),
    //         'additional_settings.show_in_columns.required' => ValidationType::Required->getMessage(),
    //         'additional_settings.show_in_columns.required_with' => ValidationType::RequiredWith->getMessage(),
    //         'additional_settings.show_in_columns.boolean' => ValidationType::Boolean->getMessage(),
    ...
    // {
    //     return [
    //         'question_bank_id' => FieldName::QuestionBankId->getMessage(),
    ...
    //         'options' => FieldName::Options->getMessage(),
    //         'options.*.text' => FieldName::Text->getMessage(),
    //         'options.*.correct' => FieldName::Correct->getMessage(),
    //         'options.*.feedback' => FieldName::Feedback->getMessage(),
    //         'additional_settings' => FieldName::AdditionalSettings->getMessage(),
    //         'additional_settings.randomize_order' => FieldName::RandomizeOrder->getMessage(),
    //         'additional_settings.show_in_columns' => FieldName::ShowInColumns->getMessage(),
