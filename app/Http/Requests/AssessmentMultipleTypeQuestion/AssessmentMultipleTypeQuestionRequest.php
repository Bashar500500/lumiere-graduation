...
namespace App\Http\Requests\AssessmentMultipleTypeQuestion;
...
class AssessmentMultipleTypeQuestionRequest extends FormRequest
{
    ...
    protected function onStore() {
        return [
            'assessment_id' => ['required', 'exists:assessments,id'],
            'type' => ['required', new Enum(AssessmentMultipleTypeQuestionType::class)],
            'text' => ['required', 'string'],
            'points' => ['required', 'integer', 'gt:0'],
            'difficulty' => ['required', new Enum(AssessmentMultipleTypeQuestionDifficulty::class)],
    ...
    protected function onUpdate() {
        return [
            'type' => ['sometimes', new Enum(AssessmentMultipleTypeQuestionType::class)],
            'text' => ['sometimes', 'string'],
            'points' => ['sometimes', 'integer', 'gt:0'],
            'difficulty' => ['sometimes', new Enum(AssessmentMultipleTypeQuestionDifficulty::class)],
