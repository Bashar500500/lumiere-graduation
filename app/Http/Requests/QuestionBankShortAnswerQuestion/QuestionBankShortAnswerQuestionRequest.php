...
namespace App\Http\Requests\QuestionBankShortAnswerQuestion;
...
class QuestionBankShortAnswerQuestionRequest extends FormRequest
{
    ...
    protected function onStore() {
        return [
            ...
            'difficulty' => ['required', new Enum(QuestionBankShortAnswerQuestionDifficulty::class)],
            'category' => ['required', 'string'],
            'required' => ['required', 'boolean'],
            'answer_type' => ['required', new Enum(QuestionBankShortAnswerQuestionAnswerType::class)],
    ...
    protected function onUpdate() {
        return [
            ...
            'difficulty' => ['sometimes', new Enum(QuestionBankShortAnswerQuestionDifficulty::class)],
            'category' => ['sometimes', 'string'],
            'required' => ['sometimes', 'boolean'],
            'answer_type' => ['sometimes', new Enum(QuestionBankShortAnswerQuestionAnswerType::class)],
